...
<!-- Map으로 넘어온 속성들의 이름을 다시 간단하게 설정합니다. -->
...
<body>
	<form name="frmArticle" method="post" action="${contextPath}"
		...
		<table border=0 align="center">
			...
			<!-- imageFileList가 비어 있지 않으면 이미지를 표시합니다. -->
			<c:if test="${not empty imageFileList && imageFileList!='null' }">
				<!-- forEach 태그를 이용해 이미지 개수만큼 반복해서 다운로드 합니다. -->
			...
			<tr id="tr_btn">
				<td colspan="2" align="center">
					<!-- 로그인 ID가 작성자 ID와 같은 경우에만 수정하기, 삭제하기 버튼이 표시됩니다. --> <c:if
